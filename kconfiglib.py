...
DEFAULT_AUTOHEADER_PATH = "config.h"
DEFAULT_AUTOHEADER_PREAMBLE = "/* Generated by Kconfiglib (https://github.com/ulfalizer/Kconfiglib) */\n"
...
class Kconfig(object):
    ...
    def write_autoconf(self, filename=None, header=None):
        ...
        filename (default: None):
          ...
          KCONFIG_AUTOHEADER is used if set, and DEFAULT_AUTOHEADER_PATH
          otherwise.
        ...
        header (default: None):
          ...
          If None (the default), the string in the environment variable
          KCONFIG_AUTOHEADER_PREAMBLE is used if set, and
          DEFAULT_AUTOHEADER_PREAMBLE otherwise.
          """
        if filename is None:
            filename = os.getenv("KCONFIG_AUTOHEADER", DEFAULT_AUTOHEADER_PATH)

        if header is None:
            header = os.getenv("KCONFIG_AUTOHEADER_PREAMBLE",
                            DEFAULT_AUTOHEADER_PREAMBLE)
